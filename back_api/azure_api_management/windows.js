...
const resourceGroupName = _generateRandomId("cloudmachine-windows", randomIds);
const vmName = _generateRandomId("windows-vm", randomIds);
...
const publisher = "MicrosoftWindowsServer";
const offer = "WindowsServer";
const sku = "2019-Datacenter";
